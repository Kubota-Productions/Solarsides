...
namespace EoleEditor
{
    ...
    {
        WindManager script;
        private Vector3 oldRotation; // store the rotation to refresh after each modification
        ...
        public override void OnInspectorGUI()
        {
            ...
            // Check if transform has been modified
            if (GUI.changed || script.transform.eulerAngles != oldRotation)
            {
                oldRotation = script.transform.eulerAngles;
                script.ApplyModification();
            }
