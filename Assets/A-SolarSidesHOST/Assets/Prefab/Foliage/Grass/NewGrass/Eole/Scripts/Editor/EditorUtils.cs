...
namespace EoleEditor
{
    public static class EditorUtils
    {
        ...
        public static void DrawEoleLabelVersion()
        {
            ...
            EditorGUILayout.LabelField("Eole - Version 1.1.0", centeredStyle);
        }
        ...
        public static List<GameObject> FindObjectsWithSubstring(string substring)
        {
            List<GameObject> objectsWithSubstring = new();

            // Get all active gameOjects in the scene
            ...
            foreach (GameObject obj in allObjects)
            {
                ...
                {
                    objectsWithSubstring.Add(obj);
                }
            }

            return objectsWithSubstring;
        }
        ...
        public static GameObject InstantiateCameraCrushRenderTexture(bool useDialog = true)
        {
            ...
            bool b = useDialog ? UnityEditor.EditorUtility.DisplayDialog("Crush Camera reference error", "EoleManager > GlobalShaderCrush component requires a specific 'Crush Camera'.\nCreate a new one?", "Yes", "No") : true;
