...
Shader "Eole/URP/Tree Leaf"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float CheapContrast1_g3658( float In, float Value )
			{
				float A = 0 - Value;
				float B = 1 + Value;
				return clamp(0,1, lerp(A,B,In));
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float wpo_CoordMask184_g3635 = v.ase_color.r;
				...
				float3 wpo_wind_direction306_g3635 = worldToObjDir141_g2754;
				float3 temp_output_26_0_g3637 = wpo_wind_direction306_g3635;
				float dotResult7_g3637 = dot( temp_output_26_0_g3637 , _RelativeUp );
				float lerpResult10_g3637 = lerp( -1.570796 , 1.570796 , ( ( dotResult7_g3637 * 0.5 ) + 0.5 ));
				float3 rotatedValue17_g3637 = RotateAroundAxis( float3( 0,0,0 ), temp_output_26_0_g3637, normalize( cross( _RelativeUp , temp_output_26_0_g3637 ) ), lerpResult10_g3637 );
				...
				float temp_output_421_0_g3635 = temp_output_2250_0;
				float debug_disableWPO486_g3635 = DebugDisableWPO;
				#ifdef _DEBUGDISABLEWINDDPO_ON
				float staticSwitch479_g3635 = ( debug_disableWPO486_g3635 == 1.0 ? 0.0 : temp_output_421_0_g3635 );
				#else
				float staticSwitch479_g3635 = temp_output_421_0_g3635;
				#endif
				float wpo_wind_mask302_g3635 = staticSwitch479_g3635;
				float temp_output_25_0_g3637 = wpo_wind_mask302_g3635;
				float lerpResult21_g3637 = lerp( 0.0 , _SimpleWindyYOffset , temp_output_25_0_g3637);
				float3 appendResult23_g3637 = (float3(0.0 , lerpResult21_g3637 , 0.0));
				float3 temp_output_454_0_g3635 = ( wpo_CoordMask184_g3635 * ( ( rotatedValue17_g3637 + appendResult23_g3637 ) * _SimpleWindDisplacement * temp_output_25_0_g3637 ) );
				#ifdef _WIND_SIMPLE
				float3 staticSwitch425_g3635 = temp_output_454_0_g3635;
				#else
				float3 staticSwitch425_g3635 = float3( 0,0,0 );
				#endif
				float3 out_wpo_windy423_g3635 = staticSwitch425_g3635;
				float3 out_wpo_crush432_g3635 = out_wpo_windy423_g3635;
				float smoothstepResult112_g3640 = smoothstep( 0.0 , _TurbulenceSmoothstepMax , wpo_wind_mask302_g3635);
				float temp_output_153_0_g3640 = saturate( smoothstepResult112_g3640 );
				float3 temp_output_88_0_g3640 = wpo_wind_direction306_g3635;
				float4 transform119_g3640 = mul(GetObjectToWorldMatrix(),float4( 0,0,0,1 ));
				float mulTime95_g3640 = _TimeParameters.x * _TurbulenceSpeed;
				float3 ase_objectScale = float3( length( GetObjectToWorldMatrix()[ 0 ].xyz ), length( GetObjectToWorldMatrix()[ 1 ].xyz ), length( GetObjectToWorldMatrix()[ 2 ].xyz ) );
				float temp_output_99_0_g3640 = ( cos( ( ( ( ( ( transform119_g3640.x * 100.0 ) + ( transform119_g3640.z * 33.0 ) ) - mulTime95_g3640 ) + v.positionOS.xyz.y ) / _TurbulenceFrequency ) ) * _TurbulenceDisplacement * ase_objectScale.y * v.ase_color.r );
				float3 temp_output_492_0_g3635 = ( out_wpo_crush432_g3635 + ( temp_output_153_0_g3640 * temp_output_88_0_g3640 * temp_output_99_0_g3640 ) );
				#ifdef _WIND_SIMPLE
				float3 staticSwitch440_g3635 = temp_output_492_0_g3635;
				#else
				float3 staticSwitch440_g3635 = float3( 0,0,0 );
				#endif
				#ifdef _DEBUGDISABLEWINDDPO_ON
				float3 staticSwitch466_g3635 = ( debug_disableWPO486_g3635 == 1.0 ? out_wpo_crush432_g3635 : staticSwitch440_g3635 );
				#else
				float3 staticSwitch466_g3635 = staticSwitch440_g3635;
				#endif
				...
				float3 vertexValue = staticSwitch466_g3635;
						 ...
						 ) : SV_Target
			{
				...
				float4 transform450_g3653 = mul(GetObjectToWorldMatrix(),float4( 0,0,0,1 ));
				float temp_output_452_0_g3653 = ( ( WorldPosition.y - transform450_g3653.y ) + _VariantOffset );
				float In1_g3662 = temp_output_452_0_g3653;
				float Value1_g3662 = _VariantContrast;
				float localCheapContrast1_g3662 = CheapContrast1_g3662( In1_g3662 , Value1_g3662 );
				float4 lerpResult350_g3653 = lerp( _MainBaseColor , _VariantBaseColor , saturate( localCheapContrast1_g3662 ));
				float4 appendResult442_g3653 = (float4((lerpResult350_g3653).rgb , 1.0));
				float2 uv_BaseMap53_g3653 = IN.ase_texcoord8.xy;
				float4 tex2DNode53_g3653 = tex2D( _BaseMap, uv_BaseMap53_g3653 );
				float4 _baseMap50_g3653 = tex2DNode53_g3653;
				float4 temp_output_428_0_g3653 = ( appendResult442_g3653 * _baseMap50_g3653 );
				float4 temp_output_124_0_g3657 = temp_output_428_0_g3653;
				float3 temp_output_125_0_g3657 = (temp_output_124_0_g3657).rgb;
				float _colormap_baseMap_Alpha146_g3657 = (temp_output_124_0_g3657).a;
				float4 appendResult132_g3657 = (float4(temp_output_125_0_g3657 , _colormap_baseMap_Alpha146_g3657));
				float coord_mask88_g3653 = IN.ase_color.r;
				float In1_g3658 = ( coord_mask88_g3653 - _ColorMapBlendOffset );
				float Value1_g3658 = _ColorMapFadeContrast;
				float localCheapContrast1_g3658 = CheapContrast1_g3658( In1_g3658 , Value1_g3658 );
				float3 lerpResult97_g3657 = lerp( (tex2D( ColorMap, ( ( (WorldPosition).xz + ColorMapOffset ) / ColorMapTillingSize ) )).rgb , temp_output_125_0_g3657 , saturate( ( (lerpResult350_g3653).a * localCheapContrast1_g3658 ) ));
				float3 break65_g3657 = lerpResult97_g3657;
				float4 appendResult64_g3657 = (float4(break65_g3657.x , break65_g3657.y , break65_g3657.z , _colormap_baseMap_Alpha146_g3657));
				#ifdef _USECOLORMAP_ON
				float4 staticSwitch128_g3657 = appendResult64_g3657;
				#else
				float4 staticSwitch128_g3657 = appendResult132_g3657;
				#endif
				float4 temp_output_23_0_g3660 = staticSwitch128_g3657;
				float3 objToWorld183_g2754 = mul( GetObjectToWorldMatrix(), float4( IN.ase_texcoord9.xyz, 1 ) ).xyz;
				float3 break153_g2754 = -objToWorld183_g2754;
				float2 appendResult155_g2754 = (float2(break153_g2754.x , break153_g2754.z));
				float2 _wind_UVs106_g2754 = appendResult155_g2754;
				float mulTime137_g2754 = _TimeParameters.x * ( WindOffsetSpeed / 10.0 );
				...
				float _wind_amplitude116_g2754 = WindAmplitude;
				float temp_output_2250_0 = ( smoothstepResult170_g2754 * _wind_amplitude116_g2754 );
				float windMask397_g3653 = temp_output_2250_0;
				float lerpResult71_g3660 = lerp( 1.0 , _WindBrightness , windMask397_g3653);
				float lerpResult78_g3660 = lerp( lerpResult71_g3660 , _CrushBrightness , 0.0);
				float lerpResult83_g3660 = lerp( 1.0 , lerpResult78_g3660 , saturate( ( coord_mask88_g3653 * 2.0 ) ));
				float4 appendResult29_g3660 = (float4((saturate( ( temp_output_23_0_g3660 * lerpResult83_g3660 ) )).rgb , (temp_output_23_0_g3660).a));
				float4 temp_output_518_0_g3653 = appendResult29_g3660;
				float4 _translucency_inColor32_g3655 = temp_output_518_0_g3653;
				float ase_lightIntensity = max( max( _MainLightColor.r, _MainLightColor.g ), _MainLightColor.b );
				float4 ase_lightColor = float4( _MainLightColor.rgb / ase_lightIntensity, ase_lightIntensity );
				float3 temp_cast_2 = (ase_lightColor.a).xxx;
				float3 blendOpSrc15_g3655 = temp_cast_2;
				float3 blendOpDest15_g3655 = (_translucency_inColor32_g3655).rgb;
				float3 normalizeResult19_g3655 = normalize( ( _WorldSpaceCameraPos - WorldPosition ) );
				float dotResult20_g3655 = dot( normalizeResult19_g3655 , -_MainLightPosition.xyz );
				float temp_output_22_0_g3655 = ( ( dotResult20_g3655 + 1.0 ) / 2.0 );
				float saferPower25_g3655 = abs( temp_output_22_0_g3655 );
				float ase_lightAtten = 0;
				Light ase_mainLight = GetMainLight( ShadowCoords );
				ase_lightAtten = ase_mainLight.distanceAttenuation * ase_mainLight.shadowAttenuation;
				float lerpResult3_g3655 = lerp( _TranslucencyShadows , _TranslucencyDirect , ase_lightAtten);
				float3 lerpBlendMode15_g3655 = lerp(blendOpDest15_g3655,2.0f*blendOpDest15_g3655*blendOpSrc15_g3655 + blendOpDest15_g3655*blendOpDest15_g3655*(1.0f - 2.0f*blendOpSrc15_g3655),( saturate( pow( saferPower25_g3655 , _TranslucencyDotViewPower ) ) * lerpResult3_g3655 ));
				float4 appendResult30_g3655 = (float4(( saturate( lerpBlendMode15_g3655 )) , (_translucency_inColor32_g3655).a));
				#ifdef _USETRANSLUCENCY_ON
				float4 staticSwitch31_g3655 = appendResult30_g3655;
				#else
				float4 staticSwitch31_g3655 = _translucency_inColor32_g3655;
				#endif
				float4 albedo109_g3663 = staticSwitch31_g3655;
				int isDebugWind98_g3663 = ( DebugWind + DebugWindTurbulence );
				int debugWindTurbulence103_g3663 = DebugWindTurbulence;
				int debugWind105_g3663 = DebugWind;
				float4 color126_g3663 = IsGammaSpace() ? float4(0,0,0,0) : float4(0,0,0,0);
				Gradient gradient82_g3663 = NewGradient( 0, 7, 2, float4( 0.5, 0.5, 0.5, 0 ), float4( 0, 0.716, 0, 0.06471352 ), float4( 1, 1, 0, 0.2205844 ), float4( 1, 0.5698085, 0, 0.5470665 ), float4( 1, 0.3047979, 0, 0.7499962 ), float4( 1, 0, 0, 0.9411765 ), float4( 0.5626073, 0, 1, 1 ), 0, float2( 1, 0 ), float2( 1, 1 ), 0, 0, 0, 0, 0, 0 );
				float4 temp_output_106_0_g3663 = ( (float)debugWind105_g3663 == 1.0 ? SampleGradient( gradient82_g3663, windMask397_g3653 ) : albedo109_g3663 );
				float4 ifLocalVar131_g3663 = 0;
				if( debugWindTurbulence103_g3663 <= debugWind105_g3663 )
				ifLocalVar131_g3663 = temp_output_106_0_g3663;
				else
				ifLocalVar131_g3663 = color126_g3663;
				half4 color64_g3663 = IsGammaSpace() ? half4(1,1,1,0) : half4(1,1,1,0);
				float temp_output_421_0_g3635 = temp_output_2250_0;
				float debug_disableWPO486_g3635 = DebugDisableWPO;
				#ifdef _DEBUGDISABLEWINDDPO_ON
				float staticSwitch479_g3635 = ( debug_disableWPO486_g3635 == 1.0 ? 0.0 : temp_output_421_0_g3635 );
				...
				float mulTime95_g3640 = _TimeParameters.x * _TurbulenceSpeed;
				float3 ase_objectScale = float3( length( GetObjectToWorldMatrix()[ 0 ].xyz ), length( GetObjectToWorldMatrix()[ 1 ].xyz ), length( GetObjectToWorldMatrix()[ 2 ].xyz ) );
				float temp_output_99_0_g3640 = ( cos( ( ( ( ( ( transform119_g3640.x * 100.0 ) + ( transform119_g3640.z * 33.0 ) ) - mulTime95_g3640 ) + IN.ase_texcoord9.xyz.y ) / _TurbulenceFrequency ) ) * _TurbulenceDisplacement * ase_objectScale.y * IN.ase_color.r );
				float temp_output_492_85_g3635 = ( temp_output_153_0_g3640 * temp_output_99_0_g3640 );
				#ifdef _WIND_SIMPLE
				float staticSwitch442_g3635 = temp_output_492_85_g3635;
				#else
				float staticSwitch442_g3635 = 0.0;
				#endif
				float4 lerpResult62_g3663 = lerp( ifLocalVar131_g3663 , color64_g3663 , ( (float)debugWindTurbulence103_g3663 == 1.0 ? saturate( ( staticSwitch442_g3635 * 20.0 ) ) : 0.0 ));
				#ifdef _DEBUGWIND_ON
				float4 staticSwitch134_g3663 = ( (float)isDebugWind98_g3663 >= 1.0 ? lerpResult62_g3663 : albedo109_g3663 );
				#else
				float4 staticSwitch134_g3663 = albedo109_g3663;
				#endif
				
				float2 uv_NormalMap71_g3653 = IN.ase_texcoord8.xy;
				float3 unpack71_g3653 = UnpackNormalScale( tex2D( _NormalMap, uv_NormalMap71_g3653 ), _NormalStrength );
				unpack71_g3653.z = lerp( 1, unpack71_g3653.z, saturate(_NormalStrength) );
				float3 lerpResult417_g3653 = lerp( float3(0,0,1) , unpack71_g3653 , saturate( ( coord_mask88_g3653 * 3.0 ) ));
				

				float3 BaseColor = (staticSwitch134_g3663).xyz;
				float3 Normal = lerpResult417_g3653;
				float3 Emission = 0;
				float3 Specular = 0.5;
				float Metallic = 0;
				float Smoothness = 0.0;
				float Occlusion = 1;
				float Alpha = (temp_output_518_0_g3653).a;
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float4 lerpResult350_g3653 = lerp( _MainBaseColor , _VariantBaseColor , saturate( localCheapContrast1_g3662 ));
				float4 appendResult442_g3653 = (float4((lerpResult350_g3653).rgb , 1.0));
				float2 uv_BaseMap53_g3653 = IN.ase_texcoord3.xy;
				float4 tex2DNode53_g3653 = tex2D( _BaseMap, uv_BaseMap53_g3653 );
				float4 _baseMap50_g3653 = tex2DNode53_g3653;
				float4 temp_output_428_0_g3653 = ( appendResult442_g3653 * _baseMap50_g3653 );
				float4 temp_output_124_0_g3657 = temp_output_428_0_g3653;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float4 lerpResult350_g3653 = lerp( _MainBaseColor , _VariantBaseColor , saturate( localCheapContrast1_g3662 ));
				float4 appendResult442_g3653 = (float4((lerpResult350_g3653).rgb , 1.0));
				float2 uv_BaseMap53_g3653 = IN.ase_texcoord4.xy;
				float4 tex2DNode53_g3653 = tex2D( _BaseMap, uv_BaseMap53_g3653 );
				float4 _baseMap50_g3653 = tex2DNode53_g3653;
				float4 temp_output_428_0_g3653 = ( appendResult442_g3653 * _baseMap50_g3653 );
				float4 temp_output_124_0_g3657 = temp_output_428_0_g3653;
				...
				#endif
				float4 temp_output_23_0_g3660 = staticSwitch128_g3657;
				float3 objToWorld183_g2754 = mul( GetObjectToWorldMatrix(), float4( IN.ase_texcoord5.xyz, 1 ) ).xyz;
				float3 break153_g2754 = -objToWorld183_g2754;
				float2 appendResult155_g2754 = (float2(break153_g2754.x , break153_g2754.z));
				float2 _wind_UVs106_g2754 = appendResult155_g2754;
				float mulTime137_g2754 = _TimeParameters.x * ( WindOffsetSpeed / 10.0 );
				...
				float mulTime95_g3640 = _TimeParameters.x * _TurbulenceSpeed;
				float3 ase_objectScale = float3( length( GetObjectToWorldMatrix()[ 0 ].xyz ), length( GetObjectToWorldMatrix()[ 1 ].xyz ), length( GetObjectToWorldMatrix()[ 2 ].xyz ) );
				float temp_output_99_0_g3640 = ( cos( ( ( ( ( ( transform119_g3640.x * 100.0 ) + ( transform119_g3640.z * 33.0 ) ) - mulTime95_g3640 ) + IN.ase_texcoord5.xyz.y ) / _TurbulenceFrequency ) ) * _TurbulenceDisplacement * ase_objectScale.y * IN.ase_color.r );
				float temp_output_492_85_g3635 = ( temp_output_153_0_g3640 * temp_output_99_0_g3640 );
				#ifdef _WIND_SIMPLE
				float staticSwitch442_g3635 = temp_output_492_85_g3635;
				#else
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float4 lerpResult350_g3653 = lerp( _MainBaseColor , _VariantBaseColor , saturate( localCheapContrast1_g3662 ));
				float4 appendResult442_g3653 = (float4((lerpResult350_g3653).rgb , 1.0));
				float2 uv_BaseMap53_g3653 = IN.ase_texcoord2.xy;
				float4 tex2DNode53_g3653 = tex2D( _BaseMap, uv_BaseMap53_g3653 );
				float4 _baseMap50_g3653 = tex2DNode53_g3653;
				float4 temp_output_428_0_g3653 = ( appendResult442_g3653 * _baseMap50_g3653 );
				float4 temp_output_124_0_g3657 = temp_output_428_0_g3653;
				...
				float mulTime95_g3640 = _TimeParameters.x * _TurbulenceSpeed;
				float3 ase_objectScale = float3( length( GetObjectToWorldMatrix()[ 0 ].xyz ), length( GetObjectToWorldMatrix()[ 1 ].xyz ), length( GetObjectToWorldMatrix()[ 2 ].xyz ) );
				float temp_output_99_0_g3640 = ( cos( ( ( ( ( ( transform119_g3640.x * 100.0 ) + ( transform119_g3640.z * 33.0 ) ) - mulTime95_g3640 ) + IN.ase_texcoord3.xyz.y ) / _TurbulenceFrequency ) ) * _TurbulenceDisplacement * ase_objectScale.y * IN.ase_color.r );
				float temp_output_492_85_g3635 = ( temp_output_153_0_g3640 * temp_output_99_0_g3640 );
				#ifdef _WIND_SIMPLE
				float staticSwitch442_g3635 = temp_output_492_85_g3635;
				#else
		...
		Pass
		{
						 ...
						 )
			{
				...
				float2 uv_NormalMap71_g3653 = IN.ase_texcoord5.xy;
				float3 unpack71_g3653 = UnpackNormalScale( tex2D( _NormalMap, uv_NormalMap71_g3653 ), _NormalStrength );
				unpack71_g3653.z = lerp( 1, unpack71_g3653.z, saturate(_NormalStrength) );
				float coord_mask88_g3653 = IN.ase_color.r;
				float3 lerpResult417_g3653 = lerp( float3(0,0,1) , unpack71_g3653 , saturate( ( coord_mask88_g3653 * 3.0 ) ));
				...
				float4 lerpResult350_g3653 = lerp( _MainBaseColor , _VariantBaseColor , saturate( localCheapContrast1_g3662 ));
				float4 appendResult442_g3653 = (float4((lerpResult350_g3653).rgb , 1.0));
				float2 uv_BaseMap53_g3653 = IN.ase_texcoord5.xy;
				float4 tex2DNode53_g3653 = tex2D( _BaseMap, uv_BaseMap53_g3653 );
				float4 _baseMap50_g3653 = tex2DNode53_g3653;
				float4 temp_output_428_0_g3653 = ( appendResult442_g3653 * _baseMap50_g3653 );
				float4 temp_output_124_0_g3657 = temp_output_428_0_g3653;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float4 transform450_g3653 = mul(GetObjectToWorldMatrix(),float4( 0,0,0,1 ));
				float temp_output_452_0_g3653 = ( ( ase_worldPos.y - transform450_g3653.y ) + _VariantOffset );
				float In1_g3662 = temp_output_452_0_g3653;
				float Value1_g3662 = _VariantContrast;
				float localCheapContrast1_g3662 = CheapContrast1_g3662( In1_g3662 , Value1_g3662 );
				float4 lerpResult350_g3653 = lerp( _MainBaseColor , _VariantBaseColor , saturate( localCheapContrast1_g3662 ));
				float4 appendResult442_g3653 = (float4((lerpResult350_g3653).rgb , 1.0));
				float2 uv_BaseMap53_g3653 = IN.ase_texcoord1.xy;
				float4 tex2DNode53_g3653 = tex2D( _BaseMap, uv_BaseMap53_g3653 );
				float4 _baseMap50_g3653 = tex2DNode53_g3653;
				float4 temp_output_428_0_g3653 = ( appendResult442_g3653 * _baseMap50_g3653 );
				float4 temp_output_124_0_g3657 = temp_output_428_0_g3653;
				...
				float Value1_g3658 = _ColorMapFadeContrast;
				float localCheapContrast1_g3658 = CheapContrast1_g3658( In1_g3658 , Value1_g3658 );
				float3 lerpResult97_g3657 = lerp( (tex2D( ColorMap, ( ( (ase_worldPos).xz + ColorMapOffset ) / ColorMapTillingSize ) )).rgb , temp_output_125_0_g3657 , saturate( ( (lerpResult350_g3653).a * localCheapContrast1_g3658 ) ));
				float3 break65_g3657 = lerpResult97_g3657;
				float4 appendResult64_g3657 = (float4(break65_g3657.x , break65_g3657.y , break65_g3657.z , _colormap_baseMap_Alpha146_g3657));
				#ifdef _USECOLORMAP_ON
				float4 staticSwitch128_g3657 = appendResult64_g3657;
				...
				surfaceDescription.Alpha = (temp_output_518_0_g3653).a;
...
Node;AmplifyShaderEditor.FunctionNode;2250;-2223.625,-226.6916;Inherit;False;Wind System;0;;2754;04c8c7036a454954194d751ad91ea181;4,171,1,184,0,186,0,140,1;0;3;FLOAT;0;FLOAT;139;FLOAT3;24
Node;AmplifyShaderEditor.FunctionNode;2290;-1993.624,-11.69159;Inherit;False;Foliage Vertex Offset;39;;3635;0fe3090401650924eb84218df3d02dc9;7,58,1,117,0,65,0,435,1,437,1,28,1,177,2;3;421;FLOAT;0;False;422;FLOAT3;0,0,0;False;176;FLOAT;1;False;3;FLOAT3;0;FLOAT;61;FLOAT;109
Node;AmplifyShaderEditor.FunctionNode;2292;-1656.624,-203.6916;Inherit;False;Foliage Color & Shading;5;;3653;f4505f717c4abe64b899f0eb94054985;5,360,1,501,1,503,0,148,1,458,3;6;457;FLOAT;0;False;480;FLOAT;0;False;466;FLOAT;0;False;161;FLOAT;0;False;147;FLOAT;1;False;426;FLOAT;0;False;5;FLOAT3;0;FLOAT3;70;FLOAT;251;FLOAT;1;FLOAT;273
...
ASEEND*/
//CHKSM=6DF54AD7FCDDE5F286B547748B322D8F8697F56E